	PRO UTPLOT_true,IMAGE,XX,YY,NOERASE=NOERASE,	$
		...
		_EXTRA=_EXTRA,CUBIC=CUBIC,CONTOUR=CONTOUR,LCOLOR=LCOLOR, $
                ...
                BSCALED=BSCALED,trueimage_in=trueimage_in
;+
; Name:
; 
;	UTPLOT_IMAGE
...
if n_elements(trueimage_in) ne 0 then trueimage=trueimage_in
...
;
        ...
        IF N_ELEMENTS(YRANGE) EQ 2 THEN BEGIN
           ...
           trueimage = trueimage[*,YLOWCUT:YHIGHCUT,*]
...
trueimage = trueimage[XLOWCUT:XHIGHCUT,*,*]
